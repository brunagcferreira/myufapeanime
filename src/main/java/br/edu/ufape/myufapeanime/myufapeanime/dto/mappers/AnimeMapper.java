...
public class AnimeMapper {
    public static Anime convertToAnimeEntity(AnimeDTO dto) {
        ...
        anime.setPontuacao(dto.getPontuacao());
        anime.setAvaliacoesTotais(dto.getAvaliacoesTotais());
    ...
    public static AnimeDTO convertToAnimeDTO(Anime anime) {
        ...
        dto.setPontuacao(anime.getPontuacao());
        dto.setAvaliacoesTotais(anime.getAvaliacoesTotais());
